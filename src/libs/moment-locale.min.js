!(function (e, a) {
  ...
  function G(e) {
    if (null == e._isValid) {
      var a = h(e),
        ...
        t =
          !isNaN(e._d.getTime()) && a.overflow < 0 && !a.empty && !a.invalidEra && !a.invalidMonth && !a.invalidWeekday && !a.weekdayMismatch && !a.nullInput && !a.invalidFormat && !a.userInvalidated && (!a.meridiem || (a.meridiem && t));
  ...
  function fe(e, a, t) {
    e.isValid() &&
      !isNaN(t) &&
      ('FullYear' === a && Le(e.year()) && 1 === e.month() && 29 === e.date() ? ((t = m(t)), e._d['set' + (e._isUTC ? 'UTC' : '') + a](t, e.month(), ze(t, e.month()))) : e._d['set' + (e._isUTC ? 'UTC' : '') + a](t));
  }
  var n = /\d/,
    r = /\d\d/,
    pe = /\d{3}/,
  ...
  function Xe(e, a, t) {
    ...
    return r < 1 ? (s = r + ea((n = e.year() - 1), a, t)) : r > ea(e.year(), a, t) ? ((s = r - ea(e.year(), a, t)), (n = e.year() + 1)) : ((n = e.year()), (s = r)), { week: s, year: n };
  }
  function ea(e, a, t) {
    var s = $e(e, a, t),
      a = $e(e + 1, a, t);
  ...
  function _a() {
    ...
    for (var a, t, s, n = [], r = [], d = [], i = [], _ = 0; _ < 7; _++)
      (s = U([2e3, 1]).day(_)), (a = k(this.weekdaysMin(s, ''))), (t = k(this.weekdaysShort(s, ''))), (s = k(this.weekdays(s, ''))), n.push(a), r.push(t), d.push(s), i.push(a), i.push(t), i.push(s);
    n.sort(e),
      r.sort(e),
      d.sort(e),
      i.sort(e),
  ...
  function Ya(a) {
    var e;
    if (void 0 === b[a] && 'undefined' != typeof module && module && module.exports && null != a.match('^[^/\\\\]*$'))
      try {
  ...
  function fa(e, a) {
    ...
    if (((a.abbr = e), null != b[e]))
      ...
      if (null != b[a.parentLocale]) s = b[a.parentLocale]._config;
        ...
        if (null == (t = Ya(a.parentLocale))) return ha[a.parentLocale] || (ha[a.parentLocale] = []), ha[a.parentLocale].push({ name: e, config: a }), null;
        s = t._config;
      }
    return (
      (b[e] = new ne(se(s, a))),
      ...
      a &&
        ...
        ((a =
          a[xe] < 0 || 11 < a[xe]
            ...
            ? Pe
            : a[w] < 0 || 24 < a[w] || (24 === a[w] && (0 !== a[Oe] || 0 !== a[We] || 0 !== a[Ae]))
            ? w
            : a[Oe] < 0 || 59 < a[Oe]
            ? Oe
            : a[We] < 0 || 59 < a[We]
  ...
  var Da = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
    ...
    va = { UT: 0, GMT: 0, EDT: -240, EST: -300, CDT: -300, CST: -360, MDT: -360, MST: -420, PDT: -420, PST: -480 };
  function ja(e) {
    var a,
      t,
      s,
    ...
    r
      ? ((a = xa(r[4], r[3], r[2], r[5], r[6], r[7])),
        ...
        t && sa.indexOf(t) !== new Date(s[0], s[1], s[2]).getDay()
          ...
          : ((e._a = a),
            (e._tzm = ((t = r[8]), (s = r[9]), (n = r[10]), t ? va[t] : s ? 0 : 60 * (((t = parseInt(n, 10)) - (s = t % 100)) / 100) + s)),
  ...
  function Wa(e) {
    ...
    if (!e._d) {
        ...
        s = e,
          ...
          e._w &&
            ...
            (null != (n = (s = e)._w).GG || null != n.W || null != n.E
              ? ((_ = 1), (o = 4), (r = Oa(n.GG, s._a[g], Xe(S(), 1, 4).year)), (d = Oa(n.W, 1)), ((i = Oa(n.E, 1)) < 1 || 7 < i) && (m = !0))
              : ((_ = s._locale._week.dow),
                (o = s._locale._week.doy),
                (u = Xe(S(), _, o)),
                (r = Oa(n.gg, s._a[g], u.year)),
                (d = Oa(n.w, u.week)),
                null != n.d ? ((i = n.d) < 0 || 6 < i) && (m = !0) : null != n.e ? ((i = n.e + _), (n.e < 0 || 6 < n.e) && (m = !0)) : (i = _)),
            d < 1 || d > ea(r, _, o) ? (h(s)._overflowWeeks = !0) : null != m ? (h(s)._overflowWeekday = !0) : ((u = Qe(r, d, i, _, o)), (s._a[g] = u.year), (s._dayOfYear = u.dayOfYear))),
          null != e._dayOfYear && ((n = Oa(e._a[g], t[g])), (e._dayOfYear > Be(n) || 0 === e._dayOfYear) && (h(e)._overflowDayOfYear = !0), (m = Ze(n, 0, e._dayOfYear)), (e._a[xe] = m.getUTCMonth()), (e._a[Pe] = m.getUTCDate())),
          a = 0;
        a < 3 && null == e._a[a];
        ++a
      )
      ...
      24 === e._a[w] && 0 === e._a[Oe] && 0 === e._a[We] && 0 === e._a[Ae] && ((e._nextDay = !0), (e._a[w] = 0)),
  ...
  function Aa(e) {
    if (e._f === M.ISO_8601) ja(e);
      ...
      (e._a = []), (h(e).empty = !0);
      for (var a, t, s, n, r, d = '' + e._i, i = d.length, _ = 0, o = le(e._f, e._locale).match(ie) || [], m = o.length, u = 0; u < m; u++)
        (t = o[u]),
          (a = (d.match(Se(t, e)) || [])[0]) && (0 < (s = d.substr(0, d.indexOf(a))).length && h(e).unusedInput.push(s), (d = d.slice(d.indexOf(a) + a.length)), (_ += a.length)),
          me[t] ? (a ? (h(e).empty = !1) : h(e).unusedTokens.push(t), (s = t), (r = e), null != (n = a) && l(ve, s) && ve[s](n, r._a, r, s)) : e._strict && !a && h(e).unusedTokens.push(t);
      (h(e).charsLeftOver = i - _),
        0 < d.length && h(e).unusedInput.push(d),
        e._a[w] <= 12 && !0 === h(e).bigHour && 0 < e._a[w] && (h(e).bigHour = void 0),
        ...
        null !== (i = h(e).era) && (e._a[g] = e._locale.erasConvertYear(i, e._a[g])),
        Wa(e),
        ka(e);
    }
  }
  function Ea(e) {
    var a,
      ...
      n = e._i,
      r = e._f;
    if (((e._locale = e._locale || pa(e._l)), null === n || (void 0 === r && '' === n))) return V({ nullInput: !0 });
    ...
    if (R(n)) e._d = n;
      ...
      R(r)
        ...
        : 'string' == typeof r
        ? ((t = n),
          null !== (a = Sa.exec(t._i)) ? (t._d = new Date(+a[1])) : (ja(t), !1 === t._isValid && (delete t._isValid, Pa(t), !1 === t._isValid && (delete t._isValid, t._strict ? (t._isValid = !1) : M.createFromInputFallback(t)))))
        : F(r)
  ...
  function Fa(e, a, t, s, n) {
    ...
    return (
      ...
      (r._f = a),
      (r._strict = s),
      (n = new $(ka(Ea((n = r)))))._nextDay && (n.add(1, 'd'), (n._nextDay = void 0)),
      n
    );
  }
  function S(e, a, t, s) {
  ...
  function Ja(e) {
    ...
    (this._isValid = (function (e) {
      var a,
        ...
        s = !1,
        n = Na.length;
      for (a in e) if (l(e, a) && (-1 === T.call(Na, a) || (null != e[a] && isNaN(e[a])))) return !1;
      for (t = 0; t < n; ++t)
        if (e[Na[t]]) {
          if (s) return !1;
  ...
  function $a(e, a) {
    ...
    return (
      Ra(e)
        ...
        : (n = qa.exec(e))
        ? ((t = '-' === n[1] ? -1 : 1), (s = { y: 0, d: m(n[Pe]) * t, h: m(n[w]) * t, m: m(n[Oe]) * t, s: m(n[We]) * t, ms: m(Ca(1e3 * n[Ae])) * t }))
        : (n = Za.exec(e))
        ? ((t = '-' === n[1] ? -1 : 1), (s = { y: Qa(n[2], t), M: Qa(n[3], t), w: Qa(n[4], t), d: Qa(n[5], t), h: Qa(n[6], t), m: Qa(n[7], t), s: Qa(n[8], t) }))
        : null == s
        ? (s = {})
        : 'object' == typeof s &&
          ('from' in s || 'to' in s) &&
  ...
  (n.add = Ne),
    ...
    (n.from = function (e, a) {
      return this.isValid() && ((Q(e) && e.isValid()) || S(e).isValid()) ? $a({ to: this, from: e }).locale(this.locale()).humanize(!a) : this.localeData().invalidDate();
    }),
    (n.fromNow = function (e) {
      return this.from(S(), e);
    }),
    (n.to = function (e, a) {
      return this.isValid() && ((Q(e) && e.isValid()) || S(e).isValid()) ? $a({ from: this, to: e }).locale(this.locale()).humanize(!a) : this.localeData().invalidDate();
    }),
    (n.toNow = function (e) {
      return this.to(S(), e);
    }),
    ...
    (n.inspect = function () {
      ...
      var e,
        ...
        t = '';
      return (
        this.isLocal() || ((a = 0 === this.utcOffset() ? 'moment.utc' : 'moment.parseZone'), (t = 'Z')),
        (a = '[' + a + '("]'),
    ...
    (n.utcOffset = function (e, a, t) {
      ...
      return (
        ...
        (this._isUTC = !0),
        null != s && this.add(s, 'm'),
        n !== e && (!a || this._changeInProgress ? at(this, $a(e - n, 'm'), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), M.updateOffset(this, !0), (this._changeInProgress = null))),
        this
      );
    }),
    (n.utc = function (e) {
    ...
    (n.zone = e('moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/', function (e, a) {
  ...
  (r.calendar = function (e, a, t) {
    ...
    (r.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (l(this, '_monthsRegex') || Ve.call(this), e ? this._monthsStrictRegex : this._monthsRegex)
        : (l(this, '_monthsRegex') || (this._monthsRegex = Ie), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
    }),
    (r.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ? (l(this, '_monthsRegex') || Ve.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex)
        : (l(this, '_monthsShortRegex') || (this._monthsShortRegex = Ce), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
    }),
    (r.week = function (e) {
    ...
    (r.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ? (l(this, '_weekdaysRegex') || _a.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex)
    ...
    (r.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ? (l(this, '_weekdaysRegex') || _a.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        : (l(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = da), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
    }),
    (r.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ? (l(this, '_weekdaysRegex') || _a.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
        : (l(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = ia), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
    }),
    (r.isPM = function (e) {
    ...
    (M.langData = e('moment.langData is deprecated. Use moment.localeData instead.', pa));
  var kt = Math.abs;
  function Dt(e, a, t, s) {
    a = $a(a, t);
  ...
  function Et() {
    ...
    return m
      ? ((e = u(i / 60)),
        ...
        (m < 0 ? '-' : '') + 'P' + (t ? n + t + 'Y' : '') + (o ? n + o + 'M' : '') + (_ ? r + _ + 'D' : '') + (a || e || i ? 'T' : '') + (a ? d + a + 'H' : '') + (e ? d + e + 'M' : '') + (i ? d + s + 'S' : ''))
      : 'P0D';
  }
  function Ft(e) {
  ...
  var x = Ja.prototype,
    Jt =
      ...
      (x.as = function (e) {
        ...
        if ('month' === (e = i(e)) || 'quarter' === e || 'year' === e)
          switch (((a = this._days + s / 864e5), (t = this._months + gt(a)), e)) {
            case 'month':
              return t;
            case 'quarter':
              return t / 3;
      ...
      (x._bubble = function () {
        var e = this._milliseconds,
          ...
          s = this._data;
        return (
          (0 <= e && 0 <= a && 0 <= t) || (e <= 0 && a <= 0 && t <= 0) || ((e += 864e5 * Tt(wt(t) + a)), (t = a = 0)),
      ...
      (x.humanize = function (e, a) {
        ...
        return (
          ...
          'object' == typeof a && ((s = Object.assign({}, Pt, a)), null != a.s && null == a.ss && (s.ss = a.s - 1)),
          (e = this.localeData()),
          (a = Ot(this, !t, s, e)),
      ...
      (x.locale = rt),
      (x.localeData = dt),
      (x.toIsoString = e('toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)', Et)),
      (x.lang = na),
      s('X', 0, 0, 'unix'),
      s('x', 0, 0, 'valueOf'),
      p('x', ge),
      ...
      (M.updateLocale = function (e, a) {
        ...
        return (
          null != a
            ? ((s = Ma),
              null != b[e] && null != b[e].parentLocale ? b[e].set(se(b[e]._config, a)) : ((a = se((s = null != (t = Ya(e)) ? t._config : s), a)), null == t && (a.abbr = e), ((s = new ne(a)).parentLocale = b[e]), (b[e] = s)),
              ya(e))
            : null != b[e] && (null != b[e].parentLocale ? ((b[e] = b[e].parentLocale), e === ya() && ya(e)) : null != b[e] && delete b[e]),
          b[e]
        );
      }),
      (M.locales = function () {
    ...
    It =
      (M.defineLocale('ar-ly', {
        ...
        relativeTime: { future: '\u0628\u0639\u062f %s', past: '\u0645\u0646\u0630 %s', s: v('s'), ss: v('s'), m: v('m'), mm: v('m'), h: v('h'), hh: v('h'), d: v('d'), dd: v('d'), M: v('M'), MM: v('M'), y: v('y'), yy: v('y') },
        preparse: function (e) {
          return e.replace(/\u060c/g, ',');
        },
        postformat: function (e) {
    ...
    Ut = { '\u0661': '1', '\u0662': '2', '\u0663': '3', '\u0664': '4', '\u0665': '5', '\u0666': '6', '\u0667': '7', '\u0668': '8', '\u0669': '9', '\u0660': '0' },
    Gt =
      ...
      { 1: '\u0661', 2: '\u0662', 3: '\u0663', 4: '\u0664', 5: '\u0665', 6: '\u0666', 7: '\u0667', 8: '\u0668', 9: '\u0669', 0: '\u0660' }),
    Vt = { '\u0661': '1', '\u0662': '2', '\u0663': '3', '\u0664': '4', '\u0665': '5', '\u0666': '6', '\u0667': '7', '\u0668': '8', '\u0669': '9', '\u0660': '0' },
    Bt = {
      s: [
        '\u0623\u0642\u0644 \u0645\u0646 \u062b\u0627\u0646\u064a\u0629',
        '\u062b\u0627\u0646\u064a\u0629 \u0648\u0627\u062d\u062f\u0629',
    ...
    Kt =
      (M.defineLocale('ar', {
        ...
        relativeTime: { future: '\u0628\u0639\u062f %s', past: '\u0645\u0646\u0630 %s', s: j('s'), ss: j('s'), m: j('m'), mm: j('m'), h: j('h'), hh: j('h'), d: j('d'), dd: j('d'), M: j('M'), MM: j('M'), y: j('y'), yy: j('y') },
        preparse: function (e) {
          return e
            .replace(/[\u0661\u0662\u0663\u0664\u0665\u0666\u0667\u0668\u0669\u0660]/g, function (e) {
              return Vt[e];
  ...
  var Zt = { 1: '\u09e7', 2: '\u09e8', 3: '\u09e9', 4: '\u09ea', 5: '\u09eb', 6: '\u09ec', 7: '\u09ed', 8: '\u09ee', 9: '\u09ef', 0: '\u09e6' },
    ...
    Xt = { '\u09e7': '1', '\u09e8': '2', '\u09e9': '3', '\u09ea': '4', '\u09eb': '5', '\u09ec': '6', '\u09ed': '7', '\u09ee': '8', '\u09ef': '9', '\u09e6': '0' },
    es =
      (M.defineLocale('bn', {
        months:
          '\u099c\u09be\u09a8\u09c1\u09df\u09be\u09b0\u09bf_\u09ab\u09c7\u09ac\u09cd\u09b0\u09c1\u09df\u09be\u09b0\u09bf_\u09ae\u09be\u09b0\u09cd\u099a_\u098f\u09aa\u09cd\u09b0\u09bf\u09b2_\u09ae\u09c7_\u099c\u09c1\u09a8_\u099c\u09c1\u09b2\u09be\u0987_\u0986\u0997\u09b8\u09cd\u099f_\u09b8\u09c7\u09aa\u09cd\u099f\u09c7\u09ae\u09cd\u09ac\u09b0_\u0985\u0995\u09cd\u099f\u09cb\u09ac\u09b0_\u09a8\u09ad\u09c7\u09ae\u09cd\u09ac\u09b0_\u09a1\u09bf\u09b8\u09c7\u09ae\u09cd\u09ac\u09b0'.split(
    ...
    as = { '\u0f21': '1', '\u0f22': '2', '\u0f23': '3', '\u0f24': '4', '\u0f25': '5', '\u0f26': '6', '\u0f27': '7', '\u0f28': '8', '\u0f29': '9', '\u0f20': '0' };
  function ts(e, a, t) {
  ...
  (L = [/^gen/i, /^c[\u02bc\']hwe/i, /^meu/i, /^ebr/i, /^mae/i, /^(mez|eve)/i, /^gou/i, /^eos/i, /^gwe/i, /^her/i, /^du/i, /^ker/i]),
  ...
  M.defineLocale('br', {
    ...
    M.defineLocale('bs', {
      ...
      relativeTime: { future: 'za %s', past: 'prije %s', s: 'par sekundi', ss: ss, m: ss, mm: ss, h: ss, hh: ss, d: 'dan', dd: ss, M: 'mjesec', MM: ss, y: 'godinu', yy: ss },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 7 },
    }),
  ...
  (f = {
    ...
    (ke = 'led_\xfano_b\u0159e_dub_kv\u011b_\u010dvn_\u010dvc_srp_z\xe1\u0159_\u0159\xedj_lis_pro'.split('_')),
    (y = [/^led/i, /^\xfano/i, /^b\u0159e/i, /^dub/i, /^kv\u011b/i, /^(\u010dvn|\u010derven$|\u010dervna)/i, /^(\u010dvc|\u010dervenec|\u010dervence)/i, /^srp/i, /^z\xe1\u0159/i, /^\u0159\xedj/i, /^lis/i, /^pro/i]),
    (_ =
  ...
  M.defineLocale('cs', {
    ...
    relativeTime: { future: 'za %s', past: 'p\u0159ed %s', s: P, ss: P, m: P, mm: P, h: P, hh: P, d: P, dd: P, M: P, MM: P, y: P, yy: P },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
    ...
    M.defineLocale('de-at', {
      ...
      relativeTime: { future: 'in %s', past: 'vor %s', s: 'ein paar Sekunden', ss: '%d Sekunden', m: rs, mm: '%d Minuten', h: rs, hh: '%d Stunden', d: rs, dd: rs, w: rs, ww: '%d Wochen', M: rs, MM: rs, y: rs, yy: rs },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 4 },
    }),
    M.defineLocale('de-ch', {
      ...
      longDateFormat: { LT: 'HH:mm', LTS: 'HH:mm:ss', L: 'DD.MM.YYYY', LL: 'D. MMMM YYYY', LLL: 'D. MMMM YYYY HH:mm', LLLL: 'dddd, D. MMMM YYYY HH:mm' },
      calendar: { sameDay: '[heute um] LT [Uhr]', sameElse: 'L', nextDay: '[morgen um] LT [Uhr]', nextWeek: 'dddd [um] LT [Uhr]', lastDay: '[gestern um] LT [Uhr]', lastWeek: '[letzten] dddd [um] LT [Uhr]' },
      relativeTime: { future: 'in %s', past: 'vor %s', s: 'ein paar Sekunden', ss: '%d Sekunden', m: ds, mm: '%d Minuten', h: ds, hh: '%d Stunden', d: ds, dd: ds, w: ds, ww: '%d Wochen', M: ds, MM: ds, y: ds, yy: ds },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 4 },
    }),
  ...
  M.defineLocale('es', {
    ...
    M.defineLocale('et', {
      ...
      relativeTime: { future: '%s p\xe4rast', past: '%s tagasi', s: Ls, ss: Ls, m: Ls, mm: Ls, h: Ls, hh: Ls, d: Ls, dd: '%d p\xe4eva', M: Ls, MM: Ls, y: Ls, yy: Ls },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 4 },
    }),
  ...
  var Ys = { 1: '\u06f1', 2: '\u06f2', 3: '\u06f3', 4: '\u06f4', 5: '\u06f5', 6: '\u06f6', 7: '\u06f7', 8: '\u06f8', 9: '\u06f9', 0: '\u06f0' },
    ys = { '\u06f1': '1', '\u06f2': '2', '\u06f3': '3', '\u06f4': '4', '\u06f5': '5', '\u06f6': '6', '\u06f7': '7', '\u06f8': '8', '\u06f9': '9', '\u06f0': '0' },
    fs =
      (M.defineLocale('fa', {
        months:
  ...
  M.defineLocale('fi', {
    ...
    relativeTime: { future: '%s p\xe4\xe4st\xe4', past: '%s sitten', s: O, ss: O, m: O, mm: O, h: O, hh: O, d: O, dd: O, M: O, MM: O, y: O, yy: O },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
  ...
  M.defineLocale('gd', {
    ...
    M.defineLocale('gom-deva', {
      ...
      relativeTime: { future: '%s', past: '%s \u0906\u0926\u0940\u0902', s: Ts, ss: Ts, m: Ts, mm: Ts, h: Ts, hh: Ts, d: Ts, dd: Ts, M: Ts, MM: Ts, y: Ts, yy: Ts },
    ...
    M.defineLocale('gom-latn', {
      ...
      relativeTime: { future: '%s', past: '%s adim', s: gs, ss: gs, m: gs, mm: gs, h: gs, hh: gs, d: gs, dd: gs, M: gs, MM: gs, y: gs, yy: gs },
      dayOfMonthOrdinalParse: /\d{1,2}(er)/,
      ordinal: function (e, a) {
        switch (a) {
          case 'D':
  ...
  var ws = { 1: '\u0ae7', 2: '\u0ae8', 3: '\u0ae9', 4: '\u0aea', 5: '\u0aeb', 6: '\u0aec', 7: '\u0aed', 8: '\u0aee', 9: '\u0aef', 0: '\u0ae6' },
    bs = { '\u0ae7': '1', '\u0ae8': '2', '\u0ae9': '3', '\u0aea': '4', '\u0aeb': '5', '\u0aec': '6', '\u0aed': '7', '\u0aee': '8', '\u0aef': '9', '\u0ae6': '0' },
    Ss =
      (M.defineLocale('gu', {
        months:
  ...
  M.defineLocale('hi', {
    ...
    M.defineLocale('hr', {
      ...
      relativeTime: { future: 'za %s', past: 'prije %s', s: 'par sekundi', ss: vs, m: vs, mm: vs, h: vs, hh: vs, d: 'dan', dd: vs, M: 'mjesec', MM: vs, y: 'godinu', yy: vs },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 7 },
    });
  ...
  M.defineLocale('hu', {
    ...
    M.defineLocale('is', {
      ...
      relativeTime: { future: 'eftir %s', past: 'fyrir %s s\xed\xf0an', s: Ws, ss: Ws, m: Ws, mm: Ws, h: 'klukkustund', hh: Ws, d: Ws, dd: Ws, M: Ws, MM: Ws, y: Ws, yy: Ws },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 4 },
    }),
  ...
  var As = {
    ...
    Fs = { '\u17e1': '1', '\u17e2': '2', '\u17e3': '3', '\u17e4': '4', '\u17e5': '5', '\u17e6': '6', '\u17e7': '7', '\u17e8': '8', '\u17e9': '9', '\u17e0': '0' },
    zs =
      (M.defineLocale('km', {
        months:
    ...
    Ns = { '\u0ce7': '1', '\u0ce8': '2', '\u0ce9': '3', '\u0cea': '4', '\u0ceb': '5', '\u0cec': '6', '\u0ced': '7', '\u0cee': '8', '\u0cef': '9', '\u0ce6': '0' },
    Js =
      (M.defineLocale('kn', {
        months:
      ...
      { 1: '\u0661', 2: '\u0662', 3: '\u0663', 4: '\u0664', 5: '\u0665', 6: '\u0666', 7: '\u0667', 8: '\u0668', 9: '\u0669', 0: '\u0660' }),
    Rs = { '\u0661': '1', '\u0662': '2', '\u0663': '3', '\u0664': '4', '\u0665': '5', '\u0666': '6', '\u0667': '7', '\u0668': '8', '\u0669': '9', '\u0660': '0' },
    ta = [
      '\u06a9\u0627\u0646\u0648\u0646\u06cc \u062f\u0648\u0648\u06d5\u0645',
      '\u0634\u0648\u0628\u0627\u062a',
      '\u0626\u0627\u0632\u0627\u0631',
  ...
  M.defineLocale('me', {
    ...
    M.defineLocale('mn', {
      ...
      relativeTime: { future: '%s \u0434\u0430\u0440\u0430\u0430', past: '%s \u04e9\u043c\u043d\u04e9', s: an, ss: an, m: an, mm: an, h: an, hh: an, d: an, dd: an, M: an, MM: an, y: an, yy: an },
  ...
  var tn = { 1: '\u0967', 2: '\u0968', 3: '\u0969', 4: '\u096a', 5: '\u096b', 6: '\u096c', 7: '\u096d', 8: '\u096e', 9: '\u096f', 0: '\u0966' },
  ...
  M.defineLocale('mr', {
    ...
    relativeTime: { future: '%s\u092e\u0927\u094d\u092f\u0947', past: '%s\u092a\u0942\u0930\u094d\u0935\u0940', s: nn, ss: nn, m: nn, mm: nn, h: nn, hh: nn, d: nn, dd: nn, M: nn, MM: nn, y: nn, yy: nn },
    preparse: function (e) {
      return e.replace(/[\u0967\u0968\u0969\u096a\u096b\u096c\u096d\u096e\u096f\u0966]/g, function (e) {
        return sn[e];
      });
  ...
  var rn = { 1: '\u1041', 2: '\u1042', 3: '\u1043', 4: '\u1044', 5: '\u1045', 6: '\u1046', 7: '\u1047', 8: '\u1048', 9: '\u1049', 0: '\u1040' },
    dn = { '\u1041': '1', '\u1042': '2', '\u1043': '3', '\u1044': '4', '\u1045': '5', '\u1046': '6', '\u1047': '7', '\u1048': '8', '\u1049': '9', '\u1040': '0' },
    _n =
      (M.defineLocale('my', {
        months:
  ...
  M.defineLocale('pl', {
    ...
    relativeTime: { future: 'za %s', past: '%s temu', s: 'kilka sekund', ss: fn, m: fn, mm: fn, h: fn, hh: fn, d: '1 dzie\u0144', dd: '%d dni', w: 'tydzie\u0144', ww: fn, M: 'miesi\u0105c', MM: fn, y: 'rok', yy: fn },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
  ...
  (y = [
    ...
    (Ke = ['\u0622\u0686\u0631', '\u0633\u0648\u0645\u0631', '\u0627\u06b1\u0627\u0631\u0648', '\u0627\u0631\u0628\u0639', '\u062e\u0645\u064a\u0633', '\u062c\u0645\u0639', '\u0687\u0646\u0687\u0631']),
    M.defineLocale('sd', {
      months: Y,
      monthsShort: Y,
      weekdays: Ke,
    ...
    (Ht = 'janu\xe1r_febru\xe1r_marec_apr\xedl_m\xe1j_j\xfan_j\xfal_august_september_okt\xf3ber_november_december'.split('_')),
  ...
  M.defineLocale('sk', {
    ...
    relativeTime: { future: 'za %s', past: 'pred %s', s: Tn, ss: Tn, m: Tn, mm: Tn, h: Tn, hh: Tn, d: Tn, dd: Tn, M: Tn, MM: Tn, y: Tn, yy: Tn },
    dayOfMonthOrdinalParse: /\d{1,2}\./,
    ordinal: '%d.',
    week: { dow: 1, doy: 4 },
  }),
    M.defineLocale('sl', {
      ...
      relativeTime: { future: '\u010dez %s', past: 'pred %s', s: gn, ss: gn, m: gn, mm: gn, h: gn, hh: gn, d: gn, dd: gn, M: gn, MM: gn, y: gn, yy: gn },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 7 },
    }),
  ...
  var W = {
    ...
    bn = { '\u0be7': '1', '\u0be8': '2', '\u0be9': '3', '\u0bea': '4', '\u0beb': '5', '\u0bec': '6', '\u0bed': '7', '\u0bee': '8', '\u0bef': '9', '\u0be6': '0' },
    Sn =
      (M.defineLocale('ta', {
        months:
  ...
  M.defineLocale('tr', {
    ...
    M.defineLocale('tzl', {
      ...
      relativeTime: { future: 'osprei %s', past: 'ja%s', s: Pn, ss: Pn, m: Pn, mm: Pn, h: Pn, hh: Pn, d: Pn, dd: Pn, M: Pn, MM: Pn, y: Pn, yy: Pn },
      dayOfMonthOrdinalParse: /\d{1,2}\./,
      ordinal: '%d.',
      week: { dow: 1, doy: 4 },
    }),
  ...
  (jt = [
    ...
    (vt = ['\u0627\u062a\u0648\u0627\u0631', '\u067e\u06cc\u0631', '\u0645\u0646\u06af\u0644', '\u0628\u062f\u06be', '\u062c\u0645\u0639\u0631\u0627\u062a', '\u062c\u0645\u0639\u06c1', '\u06c1\u0641\u062a\u06c1']);
  return (
    M.defineLocale('ur', {
      months: jt,
      monthsShort: jt,
    ...
    M.defineLocale('x-pseudo', {
      ...
      calendar: { sameDay: '[T~\xf3d\xe1~\xfd \xe1t] LT', nextDay: '[T~\xf3m\xf3~rr\xf3~w \xe1t] LT', nextWeek: 'dddd [\xe1t] LT', lastDay: '[\xdd~\xe9st~\xe9rd\xe1~\xfd \xe1t] LT', lastWeek: '[L~\xe1st] dddd [\xe1t] LT', sameElse: 'L' },
      relativeTime: {
        future: '\xed~\xf1 %s',
        past: '%s \xe1~g\xf3',
